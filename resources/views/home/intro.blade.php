<div id="intro" class="tm-section">
            ...
            <div class="tm-section-col tm-content">
                <div class="tm-media">
                    <img src="{{ asset('assets/img/gallery/tn/img-11.jpg') }}" alt="Intro image">
                    <div class="tm-media-body">
                        <h2><a href="#" class="tm-text-primary">Queen Dweller</a></h2>
                ...
                <div class="tm-media">
                    <img src="{{ asset('assets/img/gallery/tn/img-12.jpg') }}" alt="Intro image">
                    <div class="tm-media-body">
                        <h2><a href="#" class="tm-text-primary">Can't Breathe</a></h2>
                        <p class="tm-mb-20 tm-text-small">
                ...
                <div class="tm-media">
                    <img src="{{ asset('assets/img/gallery/tn/img-18.jpg') }}" alt="Intro image">
                    <div class="tm-media-body">
            ...
            <!-- Intro right -->
            <div class="tm-section-col tm-parallax" data-parallax="scroll" data-image-src="{{ asset('assets/img/bgawal1.jpg') }}"></div>
        </div>